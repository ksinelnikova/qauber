...
public class WS225 {
	...
	//Enter contains text input field
	WebElement containsTextSearch = driver.findElement(By.cssSelector("input[ng-model='ctSearchKey']"));
	containsTextSearch.sendKeys("Mariya");
	
	Thread.sleep(3000);
	WebElement SearchResult = driver.findElement(By.cssSelector("tr[ng-show='!filteredReports.length']"));
	if(SearchResult.getText().equals("0 results found.")){
